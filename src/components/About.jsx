  ...
  return (
    <div ref={aboutRef} className='w-auto min-h-screen bg-black/80'>
        ...
        <div className='text-white'>
            <p className='text-white text-4xl mt-20 ml-20'><span className='text-[#C7FF39] font-extrabold text-6xl'>++</span> WHY CHOOSE US</p>
        </div>
        <div className='w-full mt-10 flex flex-row justify-around items-center'>
            <p className='text-white font-extrabold text-5xl mr-80'>PUSH YOUR <span className='text-[#C7FF39]'>LIMIT <br />FORWARD</span></p>
            <p className='text-[14px] text-white'>Train with the best experts in Bodybuilding Field. Your <br /> 
        ...
        <div className='w-full mt-20 flex justify-center items-center'>
            <div className='w-320 flex flex-wrap justify-around items-center'>
